    ...
    return (
        ...
        >
            <div className="p-4 border-b flex justify-between items-center">
                <h3 className="text-xl font-bold text-indigo-600">Innovative Hub</h3>
            ...
            <div className="p-4">
                ...
                <div className="md:hidden">
                    <ul className="space-y-4 mb-8">
                        <li>
                            <a href="#" className="w-full text-left p-2 rounded-lg flex items-center space-x-3 transition-colors duration-200 hover:bg-gray-100">
